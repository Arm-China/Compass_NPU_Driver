...
export COMPASS_DRV_RTENVAR_Z1_SIMULATOR=${CONFIG_DRV_RTENVAR_SIM_PATH}/bin/aipu_simulator_z1
export COMPASS_DRV_RTENVAR_Z2_SIMULATOR=${CONFIG_DRV_RTENVAR_SIM_PATH}/bin/aipu_simulator_z2
export COMPASS_DRV_RTENVAR_Z3_SIMULATOR=${CONFIG_DRV_RTENVAR_SIM_PATH}/bin/aipu_simulator_z3
export COMPASS_DRV_RTENVAR_X1_SIMULATOR=${CONFIG_DRV_RTENVAR_SIM_PATH}/bin/aipu_simulator_x1
...
export PATH=${CONFIG_DRV_RTENVAR_SIM_PATH}/bin/:$PATH
