...
export CONFIG_DRV_BTENVAR_JUNO_KPATH=${CONFIG_DRV_BTENVAR_BSP_BASE_DIR}/kernel/linux-6.12.54/6.12.54/
export CONFIG_DRV_BTENVAR_6CG_KPATH=${CONFIG_DRV_BTENVAR_BSP_BASE_DIR}/kernel/linux-xlnx-armchina
export CONFIG_DRV_BTENVAR_SKY1_KPATH=${CONFIG_DRV_BTENVAR_BSP_BASE_DIR}/kernel/linux-6.1.44/6.1.44/
export CONFIG_DRV_BTENVAR_CROSS_CXX_SKY1_PATH=${CONFIG_DRV_BTENVAR_BASE_DIR}/toolchain/arm-gnu-toolchain-12.3.rel1-x86_64-aarch64-none-linux-gnu/bin/
...
export COMPASS_DRV_BTENVAR_CROSS_NONE_CXX=aarch64-none-linux-gnu-g++
export COMPASS_DRV_BTENVAR_CROSS_NONE_AR=aarch64-none-linux-gnu-ar
...
export COMPASS_DRV_BTENVAR_CROSS_COMPILE_NONE=aarch64-none-linux-gnu-
...
export COMPASS_DRV_BTENVAR_UMD_V_MINOR=1.1
...
export COMPASS_DRV_BTENVAR_KMD_VERSION=6.1.1
