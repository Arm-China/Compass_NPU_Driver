...
/**
 * @brief receive a dmabuf which is filled with inferred output tensor, and check
 *        the result.
 *
 */
#include "common.h"
...
int main(int argc, char *argv[])
{
    ...
    data = (char *)mmap(NULL, size, PROT_READ|PROT_WRITE, MAP_SHARED, dmabuf_output_fd, 0);
    if (data == MAP_FAILED)
    {
