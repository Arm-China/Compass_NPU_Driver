...
setenv CONFIG_DRV_RTENVAR_NUMPY_INCD_PATH    /arm/tools/python/python/3.8.5/rhe7-x86_64/lib/python3.8/site-packages/numpy/core/include/
...
setenv COMPASS_DRV_BTENVAR_UMD_V_MINOR 4.0
...
setenv COMPASS_DRV_BTENVAR_KMD_VERSION 3.5.0
