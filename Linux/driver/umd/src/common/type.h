...
inline DEV_PA_32 get_high_32(DEV_PA_64 pa) { return pa >> 32; }

inline DEV_PA_32 get_low_32(DEV_PA_64 pa) { return pa & 0xFFFFFFFF; }
...
inline JOB_ID create_full_job_id(GRAPH_ID g, JOB_ID id) { return g + id; }
