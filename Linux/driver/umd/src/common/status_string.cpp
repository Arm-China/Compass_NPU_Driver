...
#include "context.h"
namespace aipudrv {
std::map<uint32_t, std::string> MainContext::umd_status_string = {
    {AIPU_STATUS_SUCCESS, "AIPU UMD API executes successfully."},
    ...
    {AIPU_STATUS_ERROR_OPEN_DEV_FAIL,
     "AIPU device open operation failed. Please check kernel module insmod "
     "status or hardware status."},
    {AIPU_STATUS_ERROR_DEV_ABNORMAL,
     "AIPU device state is abnormal. Please check kernel module insmod status "
     "or hardware status."},
    ...
    {AIPU_STATUS_ERROR_UNKNOWN_BIN, "The type of the binary loaded is unknown. "
                                    "It cannot be loaded or executed."},
    {AIPU_STATUS_ERROR_GVERSION_UNSUPPORTED,
     "The version of the loadable graph binary provided is not supported on "
     "UMD."},
    {AIPU_STATUS_ERROR_INVALID_GBIN, "Loadable graph binary is invalid which "
                                     "contains unrecognized or invalid items."},
    {AIPU_STATUS_ERROR_TARGET_NOT_FOUND,
     "The specified target device is not found at runtime. Please double check "
     "the binary target."},
    {AIPU_STATUS_ERROR_INVALID_GRAPH_ID,
     "Graph ID provided is an invalid one which has been unloaded or never "
     "existed."},
    ...
    {AIPU_STATUS_ERROR_INVALID_JOB_ID,
     "Job ID provided is an invalid one which has been cleaned or never "
     "existed."},
    {AIPU_STATUS_ERROR_JOB_EXCEPTION,
     "The flushed job encounters exception during execution."},
    {AIPU_STATUS_ERROR_JOB_TIMEOUT, "The flushed job execution timeout."},
    {AIPU_STATUS_ERROR_OP_NOT_SUPPORTED,
     "This API call here is not supported on this platform."},
    {AIPU_STATUS_ERROR_INVALID_OP, "This API call here is invalid."},
    {AIPU_STATUS_ERROR_INVALID_SIZE, "Job size provided is an invalid one."},
    {AIPU_STATUS_ERROR_BUF_ALLOC_FAIL, "UMD fails in allocating buffers."},
    {AIPU_STATUS_ERROR_BUF_FREE_FAIL, "UMD fails in releasing buffers."},
    {AIPU_STATUS_ERROR_INVALID_CORE_ID,
     "The AIPU core ID application provides is invalid and cannot be found in "
     "system."},
    {AIPU_STATUS_ERROR_RESERVE_SRAM_FAIL,
     "UMD fails in reserving SRAM as the executable binary requested because "
     "there is no SoC SRAM or SRAM is busy."},
    {AIPU_STATUS_ERROR_INVALID_TENSOR_ID,
     "The tensor ID application provides is invalid."},
    {AIPU_STATUS_ERROR_INVALID_CLUSTER_ID,
     "The AIPU cluster ID application provides is invalid and cannot be found "
     "in system."},
    ...
    {AIPU_STATUS_ERROR_INVALID_GM, "GM is invalid."},
    {AIPU_STATUS_ERROR_INVALID_SEGMMU, "Segment MMU is invalid."},
    {AIPU_STATUS_ERROR_INVALID_QOS, "The specified QoS level is invalid."},
    {AIPU_STATUS_ERROR_INVALID_TENSOR_CNT,
     "The specified tensor count is invalid."},
    {AIPU_STATUS_ERROR_TIMEOUT, "Timeout on polling job's status"},
    {AIPU_STATUS_ERROR_NO_BATCH_QUEUE, "There's no specific batch queue"},
    {AIPU_STATUS_ERROR_DMABUF_SHARED_IO,
     "Specify dma_buf: not expect input&output buffer shared"},
    {AIPU_STATUS_ERROR_GET_SHAPE_FAILED, "Get dynamic shape failed."},
    {AIPU_STATUS_ERROR_SET_SHAPE_FAILED, "Set dynamic shape failed."},
    ...
    {AIPU_STATUS_ERROR_ZERO_TENSOR_SIZE, "The out shape tensor size is zero."},
    {AIPU_STATUS_ERROR_ALLOC_GRIP_ID, "Alloc Grip ID fail."},
    {AIPU_STATUS_ERROR_ALLOC_GROUP_ID, "Alloc Group ID fail."},
    {AIPU_STATUS_ERROR_NOT_FOUND_IN_HASHTABLE,
     "Cannot find const tensor in hashtable"},
    {AIPU_STATUS_ERROR_INVALID_COREDUMP, "Invalid coredump buffer."},
    {AIPU_STATUS_ERROR_JOB_DISPATCH_FAIL, "Job dispatch fail."},
    {AIPU_STATUS_MAX,
     "Status Max value which should not be returned to application."},
    /* AIPU layer library runtime error code */
    {AIPU_STATUS_ERROR_UNKNOWN_ERROR, "Unknown runtime error."},
    {AIPU_STATUS_ERROR_KEYBOARD_INTERRUPT,
     "The execution of the program was interrupted by the user."},
    {AIPU_STATUS_ERROR_SYSTEM_ERR, "System error."},
    ...
    {AIPU_STATUS_ERROR_OUT_OF_AIFF_SPEC,
     "Inputs or data are out of the specification of Zhouyi NPU AIFF "
     "hardware."},
    ...
    {AIPU_STATUS_ERROR_ARITHMETIC_ERR, "Arithmetic error."},
    {AIPU_STATUS_ERROR_FLOAT_POINT_ERR, "Float point error."},
    {AIPU_STATUS_ERROR_UNDERFLOW_ERR, "Underflow error."},
    {AIPU_STATUS_ERROR_OVERFLOW_ERR, "Overflow error."},
    {AIPU_STATUS_ERROR_NOT_A_NUMBER_ERR, "Float point NAN error."},
    {AIPU_STATUS_ERROR_INFINITY_ERR, "Float point INF error."},
    {AIPU_STATUS_ERROR_STRING_LENGTH_ERR, "String length too long."},
    {AIPU_STATUS_ERROR_ZERO_DIVISION_ERR, "Zero division error."}};

const char *MainContext::get_static_msg(aipu_status_t err) {
