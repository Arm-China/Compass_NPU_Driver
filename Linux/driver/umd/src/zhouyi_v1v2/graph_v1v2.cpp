...
#include "utils/log.h"
#include "zhouyi_v1v2/job_v1v2.h"
#include "zhouyi_v1v2/parser_v1v2.h"

namespace aipudrv {
GraphV12::GraphV12(void *ctx, GRAPH_ID id, DeviceBase *dev)
    : Graph(ctx, id, dev) {
...
aipu_status_t GraphV12::create_job(JOB_ID *id,
