...
public:
    bool is_set_dyn_shape_true()
    {
        return m_dynamic_shape_set_done;
    }
    ...
    {
        return m_config_in_tensor_shape.size();
    }
...
public:
    DynamicShape(JobBase &_jobbase, GraphV3X &_graph, aipu_dynshape_param_t *dyn_params);
    ~DynamicShape();
};
