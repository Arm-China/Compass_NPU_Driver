...
enum { TCB_INIT = 0, TCB_TASK, TCB_LOOP };

enum { TCB_NO_DEP = 0, TCB_IMMIDIATE_DEP, TCB_PRE_ALL_DEP };
...
#define pcoredump __data.noninit.rsvd2[1]
#define pprofiler_start __data.noninit.rsvd2[2]
...
enum { TCB_GRID_INIT = 0, TCB_GROUP_INIT, TCB_TASK };

enum { TCB_NO_DEP = 0, TCB_GROUP_DEP, TCB_PRE_ALL_DEP };
